...
| `native-image-pr-comparison-parameter`  *) | `'image details'` | A comma seperated list, which specifies the values being graphical compared on pull requests. Requires the 'native-image-pr-comparison' parameter to be true.                                                                                                                                              |
