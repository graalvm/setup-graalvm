...
export const INPUT_NI_REPORT_JOB = 'native-image-job-summary'
export const INPUT_NI_REPORT_PR = 'native-image-pr-summary'
export const INPUT_NI_REPORT_ARTIFACT = 'native-image-artifact-report'
